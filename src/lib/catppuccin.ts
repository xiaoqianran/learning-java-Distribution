...
/** Java 分布式课站独立 storage，避免与其他 learning-* 冲突 */
export const CTP_STORAGE_KEY = "java-dist-learn-ctp-flavor";
export const CTP_ACCENT_KEY = "java-dist-learn-ctp-accent";
export const DEFAULT_CTP_FLAVOR: CtpFlavor = "mocha";
/** 默认 Peach，贴近 Java 品牌橙 */
export const DEFAULT_CTP_ACCENT: CtpAccent = "peach";
